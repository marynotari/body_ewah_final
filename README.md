...
git clone https://github.com/marynotari/body_ewah_final
# If on Windows you must allow for symlinks as follows
git clone -c core.symlinks=true https://github.com/lisajamhoury/body_ewah_final

# Install and Run the Server and First Client
# Go into the Express application folder
cd body_ewah_final/express_server
...
cd body_ewah_final/browser_client
# Install dependencies
npm install
...
3. Find your ngrok address and add it to your sketch code.
